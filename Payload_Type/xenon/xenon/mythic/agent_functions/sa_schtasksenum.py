...
class SaSchtasksEnumArguments(TaskArguments):
...
class SaSchtasksEnumAlias(CoffCommandBase):
    cmd = "sa_schtasksenum"
    needs_admin = False
    help_cmd = "sa_schtasksenum [opt: server]"
    description = "[SituationalAwareness] Enumerate scheduled tasks on the local or remote computer"
    version = 1
    script_only = True
    author = "@trustedsec"
    argument_class = SaSchtasksEnumArguments
