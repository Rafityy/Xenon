...
class SaScEnumArguments(TaskArguments):
...
class SaScEnumAlias(CoffCommandBase):
    cmd = "sa_sc_enum"
    needs_admin = False
    help_cmd = "sa_sc_enum [opt:server]"
    description = "[SituationalAwareness] Enumerate services for qc, query, qfailure, and qtriggers info"
    version = 1
    script_only = True
    author = "@trustedsec"
    argument_class = SaScEnumArguments
