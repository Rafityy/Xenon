...
class SaNetviewArguments(TaskArguments):
...
class SaNetviewAlias(CoffCommandBase):
    cmd = "sa_netview"
    needs_admin = False
    help_cmd = "sa_netview"
    description = "[SituationalAwareness]  	List reachable computers in the current domain"
    version = 1
    script_only = True
    author = "@trustedsec"
    argument_class = SaNetviewArguments
